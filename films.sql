...
CREATE TABLE `Аппаратура` (
  ...
  `ID_аппаратуры` decimal(5,1) DEFAULT NULL,
  `Наименование` varchar(27) DEFAULT NULL,
  `Год_выпуска` smallint(6) DEFAULT NULL,
  `Инвентарный_номер` mediumint(9) DEFAULT NULL,
  `Стоимость_аренды` mediumint(9) DEFAULT NULL
...
INSERT INTO `Аппаратура` VALUES (1098,13.1,'Накамерный мониор Portkeys',2006,14,8000),(1122,13.3,'Микрофон Saramonic',2007,344,20000),(1457,12.9,'Гибкий видеосвет NiceFoto',2010,84,10000),(1627,13.4,'Видеосендер Moma',2009,31,20000),(1653,12.8,'Электронный стедикам Zhiyun',2006,908,4000),(1762,13.9,'Режиссерский монитор LUTS',2009,913,40000),(1870,14.1,'Квадрокоптер Autel',2008,349,100000),(1897,12.7,'Видоискатель Kamerar',2005,57,1500),(1999,11.5,'Компендиум Fotga',2008,497,10000),(1021,13.8,'Видеокамера ISSU',2010,1111,111110),(1020,8907.0,'Штатив Woi8',2012,12309,4500);
